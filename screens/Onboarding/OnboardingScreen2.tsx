...
export default function OnboardingScreen2({ navigation }: OnboardingScreenProps) {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Support local vendors</Text>

      <Text style={styles.subtitle}>
        Choose a surprise bag or meal deal, reserve it, and pay securely through the app.
      </Text>
