...
export default function OnboardingScreen1({ navigation }: OnboardingScreenProps) {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Save food, save money</Text>

      <Text style={styles.subtitle}>
        Open the app and explore restaurants, bakeries, and cafés offering unsold surplus fresh food
